...
float compAngleX = 0.0f;   // fused roll  → maps to mouse X
float compAngleY = 0.0f;   // fused pitch → maps to mouse Y
#define ALPHA 0.96f         // 0.96 = trust gyro 96%, accel 4% — tweak if needed
